...
var Model$1 = function () {
  ...
  _createClass(Model, [{
    ...
    value: function bulkCreate() {
      ...
      var valueSets = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

      return valueSets.map(function (values) {
        return _this4.create(values);
      });
    }
...
//# sourceMappingURL=modeljs.js.map
